...
for weight_decay in [0.005, 0.011, 0.025, 0.056, 0.125]:
    os.system('python main_de_seed_sepVideo.py --gpu-index 5 --weight-decay %f' % weight_decay)

for wd in [0.005, 0.011, 0.025, 0.056, 0.125]:
    result_dir = './runs_seed/sepVideo_raw_batch9_timeLen30_tf16_sf16_tfLen48_multiFact2_lr0.000700_wd0.015000_epochs100_randSeed7_accSel/wd%.3f' % wd
